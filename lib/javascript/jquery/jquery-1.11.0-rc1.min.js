...
a:{},g[e]=d.extend(l,a,c)):void 0!==c&&(g[e]=c));return g};d.extend({expando:"jQuery"+("1.11.0-rc1"+Math.random()).replace(/\D/g,""),isReady:!0,error:function(a){throw Error(a);},noop:function(){},isFunction:function(a){return"function"===d.type(a)},isArray:Array.isArray||function(a){return"array"===d.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return 0<=a-parseFloat(a)},isEmptyObject:function(a){for(var b in a)return!1;return!0},isPlainObject:function(a){var b;
...
d.isFunction(e)||(h=!0),q&&(h?(b.call(a,e),b=null):(q=b,b=function(a,b,c){return q.call(d(a),c)})),b))for(;k<l;k++)b(a[k],c,h?e:e.call(a[k],k,b(a[k],c)));return f?a:q?b.call(a):l?b(a[0],c):g},Fa=/^(?:checkbox|radio)$/i;(function(){var a=p.createDocumentFragment(),b=p.createElement("div"),c=p.createElement("input");c.type="checkbox";b.setAttribute("className","t");b.innerHTML="  <link/><table></table><a href='/a'>a</a>";n.leadingWhitespace=3===b.firstChild.nodeType;n.tbody=!b.getElementsByTagName("tbody").length;
n.htmlSerialize=!!b.getElementsByTagName("link").length;n.html5Clone="<:nav></:nav>"!==p.createElement("nav").cloneNode(!0).outerHTML;c.checked=!0;n.noCloneChecked=c.cloneNode(!0).checked;a.appendChild(c);n.appendChecked=c.checked;a.appendChild(b);b.innerHTML="<input type='radio' checked='checked' name='t'/>";n.checkClone=b.cloneNode(!0).cloneNode(!0).lastChild.checked;n.noCloneEvent=!0;b.attachEvent&&(b.attachEvent("onclick",function(){n.noCloneEvent=!1}),b.cloneNode(!0).click());if(null==n.deleteExpando){n.deleteExpando=
!0;try{delete b.test}catch(d){n.deleteExpando=!1}}a=b=c=null})();(function(){var a,b,c=p.createElement("div");for(a in{submit:!0,change:!0,focusin:!0})b="on"+a,(n[a+"Bubbles"]=b in s)||(c.setAttribute(b,"t"),n[a+"Bubbles"]=!1===c.attributes[b].expando)})();var Oa=/^(?:input|select|textarea)$/i,sc=/^key/,tc=/^(?:mouse|contextmenu)|click/,Hb=/^(?:focusinfocus|focusoutblur)$/,Ib=/^([^.]*)(?:\.(.+)|)$/;d.event={global:{},add:function(a,b,c,e,f){var g,h,k,l,q,t,m,n,p;if(k=d._data(a)){c.handler&&(l=c,c=
l.handler,f=l.selector);c.guid||(c.guid=d.guid++);(h=k.events)||(h=k.events={});(q=k.handle)||(q=k.handle=function(a){return typeof d===D||a&&d.event.triggered===a.type?void 0:d.event.dispatch.apply(q.elem,arguments)},q.elem=a);b=(b||"").match(M)||[""];for(k=b.length;k--;)g=Ib.exec(b[k])||[],n=t=g[1],p=(g[2]||"").split(".").sort(),n&&(g=d.event.special[n]||{},n=(f?g.delegateType:g.bindType)||n,g=d.event.special[n]||{},t=d.extend({type:n,origType:t,data:e,handler:c,guid:c.guid,selector:f,needsContext:f&&
d.expr.match.needsContext.test(f),namespace:p.join(".")},l),(m=h[n])||(m=h[n]=[],m.delegateCount=0,g.setup&&!1!==g.setup.call(a,e,p,q)||(a.addEventListener?a.addEventListener(n,q,!1):a.attachEvent&&a.attachEvent("on"+n,q))),g.add&&(g.add.call(a,t),t.handler.guid||(t.handler.guid=c.guid)),f?m.splice(m.delegateCount++,0,t):m.push(t),d.event.global[n]=!0);a=null}},remove:function(a,b,c,e,f){var g,h,k,l,q,n,m,p,s,x,B,y=d.hasData(a)&&d._data(a);if(y&&(n=y.events)){b=(b||"").match(M)||[""];for(q=b.length;q--;)if(k=
Ib.exec(b[q])||[],s=B=k[1],x=(k[2]||"").split(".").sort(),s){m=d.event.special[s]||{};s=(e?m.delegateType:m.bindType)||s;p=n[s]||[];k=k[2]&&RegExp("(^|\\.)"+x.join("\\.(?:.*\\.|)")+"(\\.|$)");for(l=g=p.length;g--;)h=p[g],!f&&B!==h.origType||c&&c.guid!==h.guid||k&&!k.test(h.namespace)||e&&!(e===h.selector||"**"===e&&h.selector)||(p.splice(g,1),h.selector&&p.delegateCount--,m.remove&&m.remove.call(a,h));l&&!p.length&&(m.teardown&&!1!==m.teardown.call(a,x,y.handle)||d.removeEvent(a,s,y.handle),delete n[s])}else for(s in n)d.event.remove(a,
...
l.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,a.result=void 0,a.target||(a.target=c),b=null==b?[a]:d.makeArray(b,[a]),l=d.event.special[m]||{},e||!l.trigger||!1!==l.trigger.apply(c,b))){if(!e&&!l.noBubble&&!d.isWindow(c)){k=l.delegateType||m;Hb.test(k+m)||(h=h.parentNode);for(;h;h=h.parentNode)n.push(h),f=h;f===(c.ownerDocument||p)&&n.push(f.defaultView||f.parentWindow||s)}for(q=0;(h=n[q++])&&!a.isPropagationStopped();)a.type=1<q?k:l.bindType||m,(f=(d._data(h,"events")||{})[a.type]&&d._data(h,"handle"))&&
f.apply(h,b),(f=g&&h[g])&&f.apply&&d.acceptData(h)&&(a.result=f.apply(h,b),!1===a.result&&a.preventDefault());a.type=m;if(!(e||a.isDefaultPrevented()||l._default&&!1!==l._default.apply(n.pop(),b))&&d.acceptData(c)&&g&&c[m]&&!d.isWindow(c)){(f=c[g])&&(c[g]=null);d.event.triggered=m;try{c[m]()}catch(F){}d.event.triggered=void 0;f&&(c[g]=f)}return a.result}},dispatch:function(a){a=d.event.fix(a);var b,c,e,f,g=[],h=G.call(arguments);b=(d._data(this,"events")||{})[a.type]||[];var k=d.event.special[a.type]||
